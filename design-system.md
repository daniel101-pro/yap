...
> **Query**: "anonymous campus social app for UK university students - Gen Z, minimalist, Apple-inspired, white-dominant with dark green accent" | **Tech Stack**: nextjs | **Generated**: 3/21/2026

## 01. Foundation
- **Primary Color**: `#F5F5F7` ![#F5F5F7](https://via.placeholder.com/15/F5F5F7/000000?text=+)
- **Typography**: **Fredoka** (Headings & Body)

### Color Palette
#### Primary Brand
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F0F0F4` | ![#F0F0F4](https://via.placeholder.com/80x30/F0F0F4/F0F0F4?text=+) |
| **100** | `#E1E1EA` | ![#E1E1EA](https://via.placeholder.com/80x30/E1E1EA/E1E1EA?text=+) |
| **200** | `#C6C6D2` | ![#C6C6D2](https://via.placeholder.com/80x30/C6C6D2/C6C6D2?text=+) |
| **300** | `#AAAABB` | ![#AAAABB](https://via.placeholder.com/80x30/AAAABB/AAAABB?text=+) |
| **400** | `#8E8EA4` | ![#8E8EA4](https://via.placeholder.com/80x30/8E8EA4/8E8EA4?text=+) |
| **500** | `#71718E` | ![#71718E](https://via.placeholder.com/80x30/71718E/71718E?text=+) |
| **600** | `#5B5B71` | ![#5B5B71](https://via.placeholder.com/80x30/5B5B71/5B5B71?text=+) |
| **700** | `#444455` | ![#444455](https://via.placeholder.com/80x30/444455/444455?text=+) |
| **800** | `#2D2D39` | ![#2D2D39](https://via.placeholder.com/80x30/2D2D39/2D2D39?text=+) |
| **900** | `#15151E` | ![#15151E](https://via.placeholder.com/80x30/15151E/15151E?text=+) |
| **950** | `#0B0B0F` | ![#0B0B0F](https://via.placeholder.com/80x30/0B0B0F/0B0B0F?text=+) |

#### Neutral
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F2F2F2` | ![#F2F2F2](https://via.placeholder.com/80x30/F2F2F2/F2F2F2?text=+) |
| **100** | `#E5E5E6` | ![#E5E5E6](https://via.placeholder.com/80x30/E5E5E6/E5E5E6?text=+) |
...
| **900** | `#19191A` | ![#19191A](https://via.placeholder.com/80x30/19191A/19191A?text=+) |
