      ...
      <div className="max-w-2xl mx-auto flex items-center justify-between px-5 h-14">
        ...
        >
          {title ? (
            ...
            <h1 className="text-[20px] font-black tracking-tight text-white">Y<span className="text-exeter">_</span></h1>
          )}
        </motion.div>

        <motion.button
          whileTap={{ scale: 0.92 }}
          className="relative p-2.5 -mr-2.5 rounded-full hover:bg-white/[0.06] transition-colors duration-200 min-h-[44px] min-w-[44px] flex items-center justify-center"
        >
